...
function setup() {
	...
	sling1 = new Sling(pendulum1.body, { x: 280, y: 150 });
	sling2 = new Sling(pendulum2.body, { x: 340, y: 150 });
	sling3 = new Sling(pendulum3.body, { x: 400, y: 150 });
	sling4 = new Sling(pendulum4.body, { x: 460, y: 150 });
	sling5 = new Sling(pendulum5.body, { x: 520, y: 150 });
